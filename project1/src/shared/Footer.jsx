...
import linked from "../assets/lnk.png"
  ...
  return (
    <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
        <div className="my-12 flex flex-col md:flex-row gap-10">
            ...
            <span className="text-white ">XYZ</span></a>
            ...
            <div>
                ...
                <input type="submit" value="Subscribe" className="px-4 py-2 rounded-md -ml-2 bg-secondary cursor-pointer hover:bg-white hover:text-primary duration-300 transition-all"/>
            </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8">
          ...
          <div className="flex items-center space-x-5">
            ...
            <img src={linked} alt="" className="w-8 cursor-pointer hover:-translate-y-4 transition-all duration-300 " />
          </div>
        </div>
